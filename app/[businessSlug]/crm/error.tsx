...
export default function Error({ error, reset }: { error: Error; reset: () => void }) {
    ...
    return (
        <div className="min-h-[600px] flex items-center justify-center p-6 animate-in fade-in zoom-in duration-500">
                ...
                <div className="space-y-6">
                    ...
                    <div className="space-y-3">
                        <h2 className="text-4xl font-black text-[var(--text-primary)] tracking-tight sm:text-5xl leading-tight">
                            Well, this is <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-orange-500">unexpected.</span>
                        </h2>
                        <p className="text-lg text-[var(--text-secondary)] font-medium max-w-md mx-auto leading-relaxed opacity-80">
                            We hit a small snag while loading this page. Our team has been notified, but you can try the following to get back on track.
                        </p>
                    </div>
                </div>
                    ...
                    <div className="group relative">
                        ...
                        <div className="relative p-6 bg-[var(--muted)]/20 border border-red-500/10 rounded-2xl text-left overflow-hidden">
                            ...
                            <code className="text-[11px] font-mono text-red-400 leading-relaxed block overflow-x-auto whitespace-pre">
                                {error.stack || error.message || 'Unknown kernel exception'}
                            </code>
                        </div>
                    </div>
                )}
